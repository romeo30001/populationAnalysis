...
class TotalPopulationData(models.Model):
...
class FemalePopulationData(models.Model):
    country_name = models.CharField(max_length=255)
    country_category = models.CharField(max_length=255)
    country_code = models.CharField(max_length=3)
    indicator_name = models.CharField(max_length=255)
...
class MalePopulationData(models.Model):
    country_name = models.CharField(max_length=255)
    country_category = models.CharField(max_length=255)
    country_code = models.CharField(max_length=3)
    indicator_name = models.CharField(max_length=255)
...
class MiddleAgeData(models.Model):
    country_name = models.CharField(max_length=255)
    country_category = models.CharField(max_length=255)
    country_code = models.CharField(max_length=3)
    indicator_name = models.CharField(max_length=255)
...
class YoungAgeData(models.Model):
    country_name = models.CharField(max_length=255)
    country_category = models.CharField(max_length=255)
    country_code = models.CharField(max_length=3)
    indicator_name = models.CharField(max_length=255)
