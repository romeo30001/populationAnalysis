...
from analysis.models import PopulationData


# Register your models here.
@admin.register(PopulationData)
class PopulationDataAdmin(admin.ModelAdmin):
    list_display = ('country_name', 'country_code', 'year_1960', 'year_2022')
    search_fields = ('country_name', 'country_code', 'year_1960', 'year_2022')
    ordering = ('country_name', 'year_1960', 'year_2022',)
